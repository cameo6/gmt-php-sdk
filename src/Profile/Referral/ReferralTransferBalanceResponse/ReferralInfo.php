...
namespace Gmt\Profile\Referral\ReferralTransferBalanceResponse;

use Gmt\Core\Attributes\Required;
use Gmt\Core\Concerns\SdkModel;
use Gmt\Core\Contracts\BaseModel;
use Gmt\Profile\Referral\ReferralTransferBalanceResponse\ReferralInfo\Balance;
use Gmt\Profile\Referral\ReferralTransferBalanceResponse\ReferralInfo\Profit;

/**
 * @phpstan-import-type BalanceShape from \Gmt\Profile\Referral\ReferralTransferBalanceResponse\ReferralInfo\Balance
 * @phpstan-import-type ProfitShape from \Gmt\Profile\Referral\ReferralTransferBalanceResponse\ReferralInfo\Profit
 *
 * @phpstan-type ReferralInfoShape = array{
 *   balance: \Gmt\Profile\Referral\ReferralTransferBalanceResponse\ReferralInfo\Balance|BalanceShape,
