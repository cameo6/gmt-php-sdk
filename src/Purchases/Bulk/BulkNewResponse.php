...
use Gmt\Purchases\Bulk\BulkNewResponse\Item;
use Gmt\Purchases\Bulk\BulkNewResponse\PricePerAccount;
use Gmt\Purchases\Bulk\BulkNewResponse\Status;
use Gmt\Purchases\Bulk\BulkNewResponse\TotalPrice;

/**
 * @phpstan-import-type ItemShape from \Gmt\Purchases\Bulk\BulkNewResponse\Item
 * @phpstan-import-type PricePerAccountShape from \Gmt\Purchases\Bulk\BulkNewResponse\PricePerAccount
 * @phpstan-import-type TotalPriceShape from \Gmt\Purchases\Bulk\BulkNewResponse\TotalPrice
 *
 * @phpstan-type BulkNewResponseShape = array{
 *   bulkPurchaseID: int,
 *   countryCode: string,
 *   createdAt: string,
 ...
 * }
 */
final class BulkNewResponse implements BaseModel
{
    /** @use SdkModel<BulkNewResponseShape> */
    use SdkModel;
    ...
    /**
     * `new BulkNewResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BulkNewResponse::with(
     *   bulkPurchaseID: ...,
     *   countryCode: ...,
     *   createdAt: ...,
     *   item: ...,
