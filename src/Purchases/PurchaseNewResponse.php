...
use Gmt\Purchases\PurchaseNewResponse\PurchaseSource;
use Gmt\Purchases\PurchaseNewResponse\PurchaseType;
...
final class PurchaseNewResponse implements BaseModel
{
    ...
    /**
     * `new PurchaseNewResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * PurchaseNewResponse::with(
     *   id: ...,
     *   countryCode: ...,
     *   createdAt: ...,
     *   displayName: ...,
