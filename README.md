...
>
> **We'd love your feedback!** Please share any suggestions, bug reports, feature requests, or general thoughts by [filing an issue](https://www.github.com/stainless-sdks/gmt-php/issues/new).
...
```json
{
  "repositories": [
    {
      "type": "vcs",
      "url": "git@github.com:stainless-sdks/gmt-php.git"
    }
  ],
  "require": {
    "org-placeholder/gmt": "dev-main"
  }
}
```
...
See [the contributing documentation](https://github.com/stainless-sdks/gmt-php/tree/main/CONTRIBUTING.md).
